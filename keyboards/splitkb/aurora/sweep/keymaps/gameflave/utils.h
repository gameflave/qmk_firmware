...
bool is_long_pressed(keyrecord_t* record) {return !record->tap.count && record->event.pressed;}
bool is_long_press_released(keyrecord_t* record) {return !record->tap.count && !record->event.pressed;}
bool is_taped(keyrecord_t* record) {return record->tap.count && record->event.pressed;}
bool is_tap_released(keyrecord_t* record) {return record->tap.count && !record->event.pressed;}
